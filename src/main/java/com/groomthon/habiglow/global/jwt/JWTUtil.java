...
public class JWTUtil {
	...
	public static final String CLAIM_SOCIAL_UNIQUE_ID = "socialUniqueId";
	...
	public String createAccessToken(String id, String email) {
		return createJWT(id, email, null, TOKEN_TYPE_ACCESS, accessTokenExpiration);
	}

	// Access Token 생성 (소셜 사용자용)
	public String createAccessToken(String id, String email, String socialUniqueId) {
		return createJWT(id, email, socialUniqueId, TOKEN_TYPE_ACCESS, accessTokenExpiration);
	}

	// Refresh Token 생성
	public String createRefreshToken(String id, String email) {
		return createJWT(id, email, null, TOKEN_TYPE_REFRESH, refreshTokenExpiration);
	}

	// Refresh Token 생성 (소셜 사용자용)
	public String createRefreshToken(String id, String email, String socialUniqueId) {
		return createJWT(id, email, socialUniqueId, TOKEN_TYPE_REFRESH, refreshTokenExpiration);
	}
	...
	// JWT 생성 내부 메서드
	private String createJWT(String id, String email, String socialUniqueId, String type, long expireMs) {
		...
		if (socialUniqueId != null) {
			builder.claim(CLAIM_SOCIAL_UNIQUE_ID, socialUniqueId);
		}
	...
	// 토큰 파싱: socialUniqueId
	public Optional<String> getSocialUniqueId(String token) {
		return safelyParseClaims(token)
			.map(claims -> claims.get(CLAIM_SOCIAL_UNIQUE_ID, String.class));
	}
